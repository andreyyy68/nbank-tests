...
class TestCreateUser:
    ...
    def test_admin_can_not_create_user_with_invalid_data(self, api_manager, admin_page):
        ...
        admin_create_user_page = AdminPanelPage(admin_page).open(). create_user(username=user_data.username, password=user_data.password, message=AlertMessage.USER_CREATED_FAILED)
