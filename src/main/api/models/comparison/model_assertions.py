...
from src.main.api.models.comparison.model_comarison_configuration import ModelComparisonConfigLoader
...
class ModelAssertions:
    ...
    def match(self) -> 'ModelAssertions':
        config_loader = ModelComparisonConfigLoader('model_comparison.properties')
        ...
        if rule is not None:
            ...
            raise AssertionError(f'No comparison rule found for request {self.request.__class__.__name__}')
